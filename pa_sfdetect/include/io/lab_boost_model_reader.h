...
class LABBoostModelReader : public ModelReader {
 public:
  ...
  virtual bool Read(mybufferStreamsfface* input, seeta::fd::Classifier* model);

 private:
	 bool ReadFeatureParam(mybufferStreamsfface* input,
    seeta::fd::LABBoostedClassifier* model);
	 bool ReadBaseClassifierParam(mybufferStreamsfface* input,
    seeta::fd::LABBoostedClassifier* model);
