...
bool LABBoostModelReader::Read(mybufferStreamsfface* input,
...
bool LABBoostModelReader::ReadFeatureParam(mybufferStreamsfface* input,
...
bool LABBoostModelReader::ReadBaseClassifierParam(mybufferStreamsfface* input,
    seeta::fd::LABBoostedClassifier* model) {
