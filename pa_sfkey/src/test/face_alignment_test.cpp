...
void initFacealignmentModel(){
	point_detector = new FaceAlignment("seeta_fa_v1.0.bin");
}

vector<Point> detectKeyPoint(const Mat& img, cv::Rect face){
...
int main(int argc, char** argv)
{
  ...
  seeta::FaceAlignment point_detector("C:/Users/Administrator/Desktop/SeetaFaceEngine-master/FaceAlignment/model/seeta_fa_v1.0.bin");

  //load image
  IplImage *img_grayscale = NULL;
  img_grayscale = cvLoadImage("abm.jpg", 0);
